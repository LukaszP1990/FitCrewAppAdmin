package com.fitcrew.FitCrewAppAdmin.common;
...
public class ValidationErrorMessage {
    ...
    public static final String LAST_NAME_ERROR_MESSAGE = "Last name must be equal or grater than 2 characters and less than 20 character";
    public static final String DATE_OF_BIRTH_ERROR_MESSAGE = "Date of birth must be equal or grater than 2 characters and less than 20 character";
